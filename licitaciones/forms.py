...
class LicitacionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['obs'].widget.attrs = ({'class': 'basis-1/2 mt-2 block w-full duration-100 rounded-sm transition border border-solid focus:outline-none focus:ring text-base bg-white border-gray-400 hover:border-gray-600 text-high-emphasis focus:border-blue-700 outline-none focus:ring-blue-50', 'rows':4})
        self.fields['currency'].widget.attrs = ({'class': 'basis-1/4 mt-2 block w-full mb-8 duration-100 rounded-sm transition border border-solid focus:outline-none focus:ring text-base bg-white border-gray-400 hover:border-gray-600 text-high-emphasis focus:border-blue-700 outline-none focus:ring-blue-50'})
        self.fields['total_sum_lic'].widget.attrs = ({'class': 'basis-1/2 mt-2 block w-full duration-100 rounded-sm transition border border-solid focus:outline-none focus:ring text-base bg-white border-gray-400 hover:border-gray-600 text-high-emphasis focus:border-blue-700 outline-none focus:ring-blue-50'})
        self.fields['category'].widget.attrs = ({'class': 'basis-1/4 mt-2 block w-full duration-100 rounded-sm transition border border-solid focus:outline-none focus:ring text-base bg-white border-gray-400 hover:border-gray-600 text-high-emphasis focus:border-blue-700 outline-none focus:ring-blue-50'})
        self.fields['payment_method'].widget.attrs = ({'class': 'basis-1/4 mt-2 block w-full duration-100 rounded-sm transition border border-solid focus:outline-none focus:ring text-base bg-white border-gray-400 hover:border-gray-600 text-high-emphasis focus:border-blue-700 outline-none focus:ring-blue-50'})
        self.fields['delivery_time'].widget.attrs = ({'class': 'basis-1/2 mt-2 block w-full duration-100 rounded-sm transition border border-solid focus:outline-none focus:ring text-base bg-white border-gray-400 hover:border-gray-600 text-high-emphasis focus:border-blue-700 outline-none focus:ring-blue-50'})
        self.fields["close_date"].widget.input_type = 'date'
        self.fields['close_date'].widget.attrs = ({'class': 'basis-1/4 mt-2 block w-full duration-100 rounded-sm transition border border-solid focus:outline-none focus:ring text-base bg-white border-gray-400 hover:border-gray-600 text-high-emphasis focus:border-blue-700 outline-none focus:ring-blue-50'})
